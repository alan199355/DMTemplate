    ...
    <el-col class="logo-container"
      ...
      <div class="topbar-logo topbar-btn"
        ...
        <img src="@/assets/login-logo.png"
             class="logo">
        <p v-if="pageSize.width>=992">浙江省建工集团有限责任公司</p>
        ...
        <el-row>
          <el-col :span="24">
            <el-menu :default-active="defaultActiveIndex"
              ...
              <el-menu-item index="subSystemManage">系统管理</el-menu-item>
              <el-menu-item index="resourceManage">资源管理</el-menu-item>
              <el-menu-item index="settingManage">配置管理</el-menu-item>
              <el-menu-item index="accessManage">服务管理</el-menu-item> -->
