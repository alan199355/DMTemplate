export default {
  ...
  // 将目标路由从激活状态路由列表中移除
  removeActiveTabs ({ commit }, tabIndex) {
    commit('removeActiveTabs', tabIndex)
  },
  // 以当前页面路由名为激活状态路由
  ...
  // 存储组织管理树数据
  setOrgainzationTree ({ commit }, orgainzationTree) {
    commit('setOrgainzationTree', orgainzationTree)
  },
  // 设置左侧菜单是否折叠
  ...
  // 存储权限树
  setPermissionTree ({ commit }, permissionTree) {
    commit('setPermissionTree', permissionTree)
  },
